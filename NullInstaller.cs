...
namespace NullInstaller
{
    public partial class MainForm : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            {
                Text = "Ready - Enhanced NullInstaller with 20 universal programs",
        ...
        {
            universalPrograms.AddRange(new[]
            {
        ...
        private async Task<bool> RunInstaller(InstallerItem installer)
        {
            try
            {
                ...
                var processInfo = new ProcessStartInfo
                {
                    ...
                    RedirectStandardOutput = verboseLoggingCheck.Checked,
                    RedirectStandardError = verboseLoggingCheck.Checked,
                    CreateNoWindow = true
                };
        ...
        private async void DownloadButton_Click(object sender, EventArgs e)
        {
            ...
            tabControl.SelectedIndex = 0; // Switch to Local Files tab
        }
        ...
        private List<UniversalProgram> GetSelectedUniversalPrograms()
        {
            ...
            {
                if (item.Checked && item.Tag is UniversalProgram program)
